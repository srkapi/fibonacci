...
public class FibonacciControllerRest {
  ...
  public ResponseEntity calculateFibonacci(@RequestBody @Valid CalculatorRequest request)
      throws ApplicationException {
    try {

      FibonacciOutput result =
          this.fibonacciUseCases.execute(new FibonacciInput(request.getNumber()));
